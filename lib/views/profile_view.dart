        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const Text(
                    'Ciudadano Verificado • Oaxaca de Juárez',
            ...
            _buildOptionTile(
              ...
              subtitle: 'Manage your name, email, and identity',
              onTap: () {},
            ),
            ...
            _buildOptionTile(
              ...
              title: 'Notifications',
              subtitle: 'Push, alerts, and report updates',
              onTap: () {},
            ),
            const SizedBox(height: 8),
            _buildOptionTile(
        ...
        child: Row(
          children: [
            Container(
              padding: const EdgeInsets.all(8),
              decoration: BoxDecoration(
                color: const Color(0xFF670024).withOpacity(0.1),
